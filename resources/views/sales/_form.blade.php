...
document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    barcodeInput.addEventListener('keydown', e => {
        ...
        */
        ...
        tbody.querySelectorAll('.product').forEach(select => {
        ...
        */
        ...
        /*
        | Find the select that contains the product
        */

        const productSelect =
            productOption.closest('select');
        ...
        */
        ...
        tbody.querySelectorAll('.sale-row').forEach(row => {
            ...
            if (select.value === productOption.value) {
        ...
        */
        ...
        if (existingRow) {
            ...
            const quantityInput =
                existingRow.querySelector('.quantity');


            quantityInput.value =
                (parseFloat(quantityInput.value) || 0) + 1;
        ...
        */
            ...
            */
            ...
            if (!targetRow) {
                ...
                targetRow =
                    tbody.querySelector('.sale-row:last-child');
            ...
            */
            ...
            const select =
                targetRow.querySelector('.product');
            ...
            */
            ...
            targetRow.querySelector('.sale-price').value =
                productOption.dataset.price || 0;
            ...
            */
            ...
            targetRow.querySelector('.quantity').value = 1;
    ...
    */
    ...
    tbody.addEventListener('click', e => {
        ...
        if (
            tbody.querySelectorAll('.sale-row').length === 1
        ) {
